classdef Branch<SystemGeneral & handle & matlab.mixin.Copyable
...
%         end
        ...
        function obj=Branch(Number, Start_Location, End_Location, Capacity, StructuralType, Priority, obj1, obj2)
            if nargin == 8
                args{1} = Number;
                args{2} = StructuralType;
                args{3} = 'Branch';
                args{4} = Priority;
            else
            end
